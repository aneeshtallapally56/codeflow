    ...
    <main className="w-full h-screen overflow-y-auto bg-[#050505] min-h-screen">
      <div className="w-full px-4 md:px-12 py-10">
        <div className="w-full flex justify-between items-center flex-wrap gap-4">
          <h1 className="text-2xl text-zinc-300 font-bold tracking-tight">My Projects</h1>
          <div className="flex gap-2">
            <Button variant="outline" className="border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white">
              Join
            </Button>
